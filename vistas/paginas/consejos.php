...
<head>
    ...
    <link rel="stylesheet" href="vistas\recursos\css\style.css">
    <title>Pagina consejos Zooadmin</title>
</head>
<body>
    <br>
...
<div class="row row-cols-1 row-cols-md-2 g-4">
  <div class="col">
    <div class="card">
      <img src="vistas\recursos\images\consejos\vacuna.jpg" class="card-img-top"
        alt="Hollywood Sign on The Hill" />
      <div class="card-body">
        <h5  class="display-6">Vacunación</h5>
        <p class="card-text">
  ...
  <div class="col">
    <div class="card">
      <img src="vistas\recursos\images\consejos\desparacitacion.jpg" class="card-img-top"
        alt="Palm Springs Road" />
      <div class="card-body">
        <h5 class="display-6">Desparacitación</h5>
        <p class="card-text">
  ...
  <div class="col">
    <div class="card">
      <img src="vistas\recursos\images\consejos\comida.jpg" class="card-img-top"
        alt="Los Angeles Skyscrapers" />
      <div class="card-body">
        <h5 class="display-6">Buena alimentación</h5>
        <p class="card-text">Una alimentación balanceada le otorgará a tu mascota los nutrientes necesarios para crecer, desarrollarse y tener energía suficiente.</p>
      </div>
    </div>
  </div>
  <div class="col">
    <div class="card">
      <img src="vistas\recursos\images\consejos\pecera.jpg" class="card-img-top"
        alt="Skyscrapers" />
      <div class="card-body">
        <h5 class="display-6">Un espacio adecuado</h5>
        <p class="card-text">
    ...
    <div class="card">
      <img src="vistas\recursos\images\consejos\cariño.jpg" class="card-img-top"
        alt="Hollywood Sign on The Hill" />
      <div class="card-body">
        <h5 class="display-6">Repartición de cariño</h5>
        <p class="card-text">
    ...
    <div class="card">
      <img src="vistas\recursos\images\consejos\baño.jpg" class="card-img-top"
        alt="Hollywood Sign on The Hill" />
      <div class="card-body">
        <h5 class="display-6">Buena limpieza</h5>
        <p class="card-text">
    ...
    <div class="card">
      <img src="vistas\recursos\images\consejos\pelaje.jpg" class="card-img-top"
        alt="Hollywood Sign on The Hill" />
      <div class="card-body">
        <h5 class="display-6">El pelaje</h5>
        <p class="card-text">
    ...
    <div class="card">
      <img src="vistas\recursos\images\consejos\veterinaria.jpg" class="card-img-top"
        alt="Hollywood Sign on The Hill" />
      <div class="card-body">
        <h5 class="display-6">Chequeos y veterinarios</h5>
        <p class="card-text">
    ...
    <div class="card">
      <img src="vistas\recursos\images\consejos\gatoooos.jpg" class="card-img-top"
        alt="Hollywood Sign on The Hill" />
      <div class="card-body">
        <h5 class="display-6">La reproducción</h5>
        <p class="card-text">
    ...
    <div class="card">
      <img src="vistas\recursos\images\consejos\paseo.jpg" class="card-img-top"
        alt="Hollywood Sign on The Hill" />
      <div class="card-body">
        <h5 class="display-6">Paseos</h5>
        <p class="card-text">
